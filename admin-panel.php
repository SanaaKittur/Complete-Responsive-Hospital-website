...
if(isset($_POST['app-submit']))
{
  ...
  if(date("Y-m-d",$appdate1)>=$cur_date){
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date){
      $check_query = mysqli_query($con,"select apptime,appdate from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
      $check_query2 = mysqli_query($con,"select * from appointmenttb where email='$email' and appdate='$appdate' and doctor='$doctor'");
      #if((mysqli_num_rows($check_query)==0) and (mysqli_num_rows($check_query2)==0))
        if((mysqli_num_rows($check_query)==0 or mysqli_num_rows($check_query2)==0)){
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> DigiDoc</a>
